...
\centering
\small
\caption{Frozen architecture and experiment design}
\begin{tabular}{lrr}
\toprule
...
Financial application & Frozen QRC architecture & 2 qubits; V=2; reset\_each\_input; feature dimension 6 \\
Financial application & Reservoir seeds and exact backend & 2026, 2027, 2028; numpy\_density\_matrix\_exact \\
...
MNIST benchmark & Reservoir seeds and backend & 2026, 2027, 2028; numpy\_density\_matrix\_exact \\
...
\bottomrule
\end{tabular}
\parbox{0.98\linewidth}{\footnotesize All architecture and threshold values were frozen before final test inspection.}
\parbox{0.98\linewidth}{\footnotesize QRC execution used classical simulation; no physical QPU was used.}
\end{table*}
